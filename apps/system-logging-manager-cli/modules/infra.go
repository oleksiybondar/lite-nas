...
import (
	serviceconfig "lite-nas/apps/system-logging-manager-cli/config"
	sharedfileio "lite-nas/shared/fileio"
	sharedmodules "lite-nas/shared/modules"
)

// Infra groups infrastructure dependencies used by the CLI runtime.
type Infra struct {
	sharedmodules.CoreInfra
	Config serviceconfig.Config
}

// NewInfraModule loads configuration and constructs shared runtime infra.
