...
"$SCRIPT_DIR/build-network-metrics-binary.sh" --output="$output_dir/network-metrics"
"$SCRIPT_DIR/build-process-metrics-binary.sh" --output="$output_dir/process-metrics"
"$SCRIPT_DIR/build-disk-metrics-binary.sh" --output="$output_dir/disk-metrics"
"$SCRIPT_DIR/build-service-metrics-binary.sh" --output="$output_dir/service-metrics"
...
"$SCRIPT_DIR/build-network-metrics-cli-binary.sh" --output="$output_dir/network-metrics-cli"
