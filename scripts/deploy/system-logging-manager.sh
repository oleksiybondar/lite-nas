...
readonly LITE_NAS_SYSTEM_LOGGING_MANAGER_RUNTIME_USER="${LITE_NAS_SYSTEM_LOGGING_MANAGER_RUNTIME_USER:-lite-nas-system-logging-manager}"
...
readonly LITE_NAS_SYSTEM_LOGGING_MANAGER_LOG_DIR="${LITE_NAS_SYSTEM_LOGGING_MANAGER_LOG_DIR:-${LITE_NAS_LOG_DIR:-/var/log/lite-nas}}"
...
deploy.systemLoggingManager.enableAndStart() {
	...
	systemctl enable --now "$LITE_NAS_SYSTEM_LOGGING_MANAGER_SERVICE_NAME.service"
}
