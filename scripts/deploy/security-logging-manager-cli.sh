...
readonly LITE_NAS_SECURITY_LOGGING_MANAGER_CLI_LOG_DIR="${LITE_NAS_LOG_DIR:-/var/log/lite-nas}"
...
deploy.securityLoggingManagerCLI.installConfig() {
	...
	install -m 0640 -o root -g "$LITE_NAS_SECURITY_LOGGING_MANAGER_CLI_ACCESS_GROUP" \
