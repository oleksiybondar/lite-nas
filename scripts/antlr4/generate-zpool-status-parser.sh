...
GRAMMAR_FILE="$LITE_NAS_REPO_ROOT/shared/go/parsers/zfs/status/grammar/ZpoolStatus.g4"
OUTPUT_DIR="$LITE_NAS_REPO_ROOT/shared/go/parsers/generated/zfs/zpoolstatus"
PACKAGE_NAME="zpoolstatus"
...
log.pushTask "Generating ANTLR4 parser for zpool status"
mkdir -p "$OUTPUT_DIR"
